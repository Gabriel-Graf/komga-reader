 ...
 * Body (Hero/Grid/Dialoge/State) baut der Host, das Pack platziert ihn nur — „UI neu, Kernlogik
 * gleich". E-Ink-Invarianten und der Header-Look sind über den header-Slot bzw. den Host erzwungen,
 * nicht Teil hiervon.
 */
