...
class SourceRegistrationTest {
    ...
    // Relaxed-Mock: PluginHost benötigt einen echten Context (Android) — in Unit-Tests
    // ohne Instrumentation nicht instanziierbar. mockk(relaxed=true) gibt Null/leer zurück
    // und wird von keinem der folgenden Tests aufgerufen (alle Tests decken KOMGA/OPDS ab).
    private val noopPluginHost: PluginHost = mockk(relaxed = true)
