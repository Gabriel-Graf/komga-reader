...
/**
 * Reader-Host: selects the right reader screen based on [ReaderContent] and [ViewerMode].
 * Applies the appropriate [EinkContext] via [EinkContextEffect] so the E-Ink controller
 * automatically switches to the matching refresh profile (No-Op on non-Boox devices).
 */
@Composable
fun ReaderRoute(
    onBack: () -> Unit,
